  ...
  return (
    <div style={{ position:"relative", width:size, height:size, display:"flex", alignItems:"center", justifyContent:"center", flexShrink:0 }}>
      ...
      <svg width={size*.72} height={size*.72} viewBox="0 0 523 523" fill="none" style={{ position:"relative", zIndex:2 }}>
        ...
        <path d="M263.9 384.1C234.1 399.3 204.6 410 177.2 415.2C158.9 418.7 142.5 419.6 128.3 418.1C106.1 415.6 89.3 407.1 79.2 393C62.5 369.7 66.2 334.2 89.6 293C98.5 277.3 109.8 261.5 123.2 245.9C119.2 259.8 105.4 278.8 103.1 282.2C75 324.8 66.3 364.7 84.1 389.5C93.4 402.5 129.1 412.2 161.8 415.8C205.8 405.5 252.4 383 263.9 384.1Z" fill="#FDFFED" fillOpacity=".6"/>
        <path d="M434 231C424.8 247.2 413 263.6 399 279.6C403 265.9 417 246.7 418.9 244C422.5 238.6 428.8 228 451 189C454.7 155.8 439.5 134.6 414.6 99.8C344.7 104.9 268.7 142.2 257.4 141.2C263.1 138.2 274.4 132.8 299.1 121.4C323.5 113.2 346.4 108.8 392.9 99.9C427.7 107.8 444.4 131 461.1 154.3C457.4 189.8 434 231Z" fill="#FDFFED" fillOpacity=".6"/>
