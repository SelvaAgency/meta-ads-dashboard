...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-bold transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        default: "bg-gradient-to-r from-primary to-secondary text-primary-foreground hover:from-primary/90 hover:to-secondary/90 shadow-md hover:shadow-lg",
        destructive:
        ...
        outline:
          "border border-primary/30 bg-transparent shadow-sm hover:bg-primary/10 hover:border-primary/50 hover:shadow-md dark:bg-transparent dark:border-input dark:hover:bg-input/50",
        secondary:
          "bg-gradient-to-r from-secondary to-primary/20 text-secondary-foreground hover:from-secondary/90 hover:to-primary/30 shadow-md hover:shadow-lg",
        ghost:
          "hover:bg-secondary/20 dark:hover:bg-accent/50 hover:shadow-sm",
